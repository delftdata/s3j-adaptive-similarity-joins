...
if __name__ == "__main__":
    ...
    join_jobid_request = requests.get(f'http://coordinator:30080/get_join_jobid')
    ...
    r = requests.get(f'http://flink-rest:30080/jobs/{job_id}/plan')
    ...
    while True:
        ...
        for subtask_id in range(parallelism):
            b = requests.get(f'http://flink-rest:30080/jobs/{job_id}/vertices/{vertix_id}/subtasks/{subtask_id}/metrics'
                             f'?get={metrics}')
