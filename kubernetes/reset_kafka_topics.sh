...
kubectl exec -n kafka -ti kafka-cluster-zookeeper-0 -- bin/kafka-topics.sh --create --topic pipeline-out --bootstrap-server kafka-cluster-kafka-bootstrap:9092 --partitions 3 --replication-factor 1
kubectl exec -n kafka -ti kafka-cluster-zookeeper-0 -- bin/kafka-topics.sh --create --topic pipeline-out-stats --bootstrap-server kafka-cluster-kafka-bootstrap:9092 --partitions 3 --replication-factor 1
